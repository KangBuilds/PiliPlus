...
class PugvPanel extends StatefulWidget {
  const PugvPanel({
    super.key,
    required this.pages,
    this.cid,
  ...
  @override
  State<PugvPanel> createState() => _PugvPanelState();
}

class _PugvPanelState extends State<PugvPanel> {
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView.builder(
            key: const PageStorageKey(_PugvPanelState),
